...
P53.extended <- P53_com.sub %>%
  filter(
    P53.Mutation == "R175H" | P53.Mutation == "R248Q" |
      ...
      P53.Mutation == "R248Q" |
      # dplyr::selected based on data availiablility
      P53.Mutation == "R282W" |
      P53.Mutation == "R273L" |
      P53.Mutation == "G248S"
  )
...
P53.all_NOX4 <-
  dplyr::select(P53.all_NOX4, Sample.Id, P53.Mutation, NOX4, Cancer.Study)
...
p53_NOX4_FN1.final$NOX4.1 <- p53_NOX4_FN1.final$NOX4 + 1 # add 1 for log trans 0
...
breast.p <-  p53_NOX4_FN1.final[p53_NOX4_FN1.final$Cancer.Study %in% c("Breast Invasive Carcinoma"),]
```

```{r, fig.width = 8, fig.height=3.5, dpi=900}
p53_NOX4_FN1.final$Cancer.Study <- factor(p53_NOX4_FN1.final$Cancer.Study, levels=c("Breast Invasive Carcinoma", "Pancreatic Adenocarcinoma", "Head and Neck Squamous Cell Carcinoma")) # changes the order with factor()
